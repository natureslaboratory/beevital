...
<head>
	...
	pintrk('load', '2613183829422', {em: '<user_email_address>'});
	pintrk('page');
	</script>
	<noscript>
    ...
    tr.woocommerce-shipping-totals.shipping .checkbox_field > label .checkbox{
	    display:none;
    }
    .woocommerce-shipping-fields{
	    padding:1rem 0;
    }
    .product_listings .product::after{
	    background:none !important;
    }
    .social_links a span,.payment_methods a span,a.logo span,.play_cta a span,.close_cta span,.burger_cta span{
	    display:block;
	    width:0px;
	    height:0px;
	    overflow:hidden;
	...
	<link rel="icon" type="image/png" sizes="32x32" href="/wp-content/themes/beevital/images/favicon/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="/wp-content/themes/beevital/images/favicon/favicon-16x16.png">
	<link rel="manifest" href="/wp-content/themes/beevital/images/favicon/site.webmanifest">
...
<body>
    ...
    <div id="mobile_nav">
        ...
        <ul class="nav">
            ...
            <li>
                <a href="#" class="dropdown_toggle">Products</a>
        ...
        <div class="popup_content">
            ...
            <div class="field">
                ...
                <div class="input__submit">
                    ...
                    <input type="text" id="search" name="s" placeholder="search products…" />
        ...
        <div class="container__outer">
            ...
            <div id="header_wrapper">
                ...
                <div id="header">
                    ...
                    <a href="/cart/" class="mobile_basket_cta">
	                    <span style="display:block;width:0px;height:0px;overflow:hidden">Basket</span>
